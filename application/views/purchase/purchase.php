...
?>
<div id="pageId" class="container" style="display: none">purchase</div>
<form>
	<div class="container">
		<div id="purchaseContainer" class="form-horizontal">
			<div class="col-lg-12">

				<center>
					<h3>
						PURCHASE <span id="purchaseId"></span> <input
							style="display: none" type="text" name="LINE_purchaseId"
							id="purchaseIdTxt"> <input style="display: none" type="text"
							name="purchaseType" id="purchaseType" value="regular">
					</h3>
			...
			<div class="col-lg-12">
				<div class="form-group" style="display: none">
					<label for="poNo" class="col-lg-2 control-label"><h4>purchase #</h4></label>
					<div class="col-lg-2">
			...
			<div class="col-lg-6">
				<div class="form-group">
					...
					<div class="col-lg-6">
						<input name="supplierId" onfocus="supplierDropDown();"
							type="hidden" class="form-control" id="supplierId"
							placeholder="Enter supplier keyword"> <input name="supplierName"
							onfocus="supplierDropDown();" type="text" class="form-control"
							id="supplierName" placeholder="Enter Supplier keyword"> <span
							id="supplierDetails"></span>
					</div>
				</div>
			</div>
			<div class="col-lg-6 ">
				<div class="form-group">
					<label for="poNo" class="col-lg-4 control-label">Supplier Purchase
						Number</label>
					<div class="col-lg-8">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input onkeyup="getDateNumber('purchaseDate','entryDate');"
							onchange="getDateNumber('purchaseDate','entryDate');"
							id="purchaseDate" name="purchaseDate" type="text"
			...
			<div class="col-lg-12 table-responsive">
				...
				<hr>
				<!-- 				<input type="submit" id="submit" value="Save purchase" -->
		...
		<div class="col-lg-12">
			...
			<div class="col-lg-7 well" style="background-color: #ddd)">
				...
				<table style="font-size: 14px">
					...
					<tr>
						<td>Sales Tax</td>
						<td><select onchange="calcBill();" id="taxValue"
						...
						<td><input name="taxAmount" type="hidden"
							class="col-lg-1 text-center form-control" /></td>
		...
		<p style="padding: 1%">
			<b> Total number of Items: <span id="totalItems">0</span> | Total
				amount: <span id="totalAmount">0</span> <span class="pull-right""> <input
					type="submit" value="Save purchase" class="btn btn-primary">
			</span>
			</b>
		</p>
	</div>
