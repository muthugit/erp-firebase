...
<div id="pageId" class="container" style="display: none">production</div>
<form>
	<div class="container">
		<div id="productionContainer" class="form-horizontal">
			<div class="col-lg-12">
				<center>
					<h3>
						production <span id="productionId"></span> <input
			...
			<div class="col-lg-6">
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input type="text" name="productionNarration"
							class="form-control" id="productionNarration" placeholder="">
					</div>
				</div>
			</div>
			<div class="col-lg-6 ">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input onkeyup="getDateNumber('productionDate','entryDate');" id="productionDate"
							name="productionDate" type="text" class="form-control"> <input
			...
			<div class="col-lg-12 table-responsive">
				...
				<hr>
				<!-- 				<input type="submit" id="submit" value="Save production" -->
