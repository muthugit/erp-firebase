	...
	<div class="container">
		...
		<div class="col-lg-12">
			...
			<div class="col-lg-5">
				...
				<table class="table col-sm-12" style="font-size: 14px">
					<tr>
						<th width="40%"></th>
						<th width="60%"></th>
					</tr>
					<tr>
						...
						<td><input name="modeOfTransport" id="modeOfTransport" type="text"
							class="col-sm-6 form-control" /></td>
					</tr>
					<tr>
						<td><b>Motor Vehicle Regn. No.</b></td>
						<td><input name="motorVehicleRegnNo" id="motorVehicleRegnNo"
							type="text" class="form-control" /></td>
					</tr>
					<tr>
						<td><b>Despatch From</b></td>
						<td><input name="despatchFrom" id="despatchFrom" type="text"
							class="form-control" /></td>
					</tr>
					<tr>
						<td><b>To</b></td>
						<td><input name="despatchTo" id="despatchTo" type="text"
							class="form-control" /></td>
					</tr>
					<tr>
						<td><b>R/R.L.R. No.</b></td>
						<td><input name="rlrNo" id="rlrNo" type="text"
							class="form-control" /></td>
					</tr>
				</table>
			</div>
			<div class="col-lg-7 well" style="background-color: #ddd)">
				...
				<table style="font-size: 14px">
					...
					<tr>
						<td>Mahamai</td>
						<td><select onchange="calcBill();" class="form-control"
							name="mahamaiCalcBy" id="mahamaiCalcBy" style="width: 100%"
							class=""><option value="percentage">%</option>
								<option value="amount">Rs.</option></select></td>
						<td><input onkeyup="calcBill();" name="mahamaiValue"
							id="mahamaiValue" type="text"
							class="col-lg-1 text-center form-control" /> <input
							name="mahamaiAmount" type="hidden" id="mahamaiAmount"></td>
						<td class="text-right"><span id="mahamaiAmountText" /></td>
					</tr>
					<tr>
						<td>Insurance</td>
						<td><select onchange="calcBill();" class="form-control"
							name="insuranceCalcBy" id="insuranceCalcBy" style="width: 100%"
							class=""><option value="percentage">%</option>
								<option value="amount">Rs.</option></select></td>
						<td><input onkeyup="calcBill();" name="insuranceValue"
							id="insuranceValue" type="text"
							class="col-lg-1 text-center form-control" /> <input
							name="insuranceAmount" type="hidden" id="insuranceAmount"></td>
						<td class="text-right"><span id="insuranceAmountText" /></td>
					</tr>
					<tr>
						<td>Sales Tax</td>
						<td><select onchange="calcBill();" id="taxValue" name="taxValue"
							class="form-control" style="width: 100%" class=""><option
								...
								<option value="14.5">VAT 14.5%</option>
		...
		<p style="padding: 1%">
			<b> Total number of Items: <span id="totalItems">0</span> | Total
				amount: <span id="totalAmount">0</span> <span class="pull-right""> <input
					...
					<a id="printBtn" style="display:none" class="btn btn-primary" href="">Print</a>
			</span>
			</b>
		</p>
	</div>
...
?>
<script src="<?php echo JS_PATH?>crackerInvoice.js"></script>
<script>
// $("#baseErpHeader").hide();
// $("#baseErpFooter").hide();
